...
import Image from "../assets/img/man_about.jpg";

const About = () => {
  return (
    <section
      className="section relative lg:before:content-pattern lg:before:absolute lg:before:top-[332px] lg:before:left-[180px]
    lg:after:content-rope lg:after:absolute lg:after:overflow-hidden lg:after:left-0 lg:after:right-0 lg:after:top-1/2 "
      id="about"
    >
      <div className="container mx-auto">
        ...
        <p className="section-subtitle lg:mb-[20px]">{about.subtitle}</p>
